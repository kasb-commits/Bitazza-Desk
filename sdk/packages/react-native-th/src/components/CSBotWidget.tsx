...
import { getAsyncStorageAdapter } from '../storage';
import { ISSUE_CATEGORIES_TH } from '../categories';
...
export function CSBotWidget({ apiUrl, platform = 'bitazza', token, primaryColor, ...rest }: Props) {
      ...
      >
        <View style={styles.modalOverlay}>
          <ChatWindow
            cfg={cfg}
            storage={storage}
            categories={ISSUE_CATEGORIES_TH}
