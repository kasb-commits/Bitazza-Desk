      ...
      <div className="flex-1 overflow-hidden" style={{ position: 'relative', zIndex: 1 }}>
        {selectedId
          ? <MessageThread
            ...
            />
          : (
            <div className="flex flex-col items-center justify-center h-full gap-4" style={{ background: 'var(--surface-1)' }}>
              <div className="w-12 h-12 rounded-full flex items-center justify-center" style={{ background: 'var(--surface-3)', border: '1px solid var(--surface-5)', color: 'var(--text-muted)' }}>
                {Icons.inbox}
              </div>
              <div className="text-center">
                <p className="text-sm font-medium" style={{ color: 'var(--text-primary)' }}>Select a conversation</p>
                <p className="text-xs mt-1" style={{ color: 'var(--text-muted)' }}>Choose a ticket from the list to start</p>
              </div>
            </div>
          )
        }
